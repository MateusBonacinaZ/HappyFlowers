...
const routes = [
    ...
    {
        path: 'config',
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_config_config_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./pages/config/config.module */ 87564)).then(m => m.ConfigPageModule)
    },
    {
        path: 'details',
    ...
    },
    {
        ...
        loadChildren: () => __webpack_require__.e(/*! import() */ "src_app_pages_connection-error_connection-error_module_ts").then(__webpack_require__.bind(__webpack_require__, /*! ./pages/connection-error/connection-error.module */ 93664)).then(m => m.ConnectionErrorPageModule)
    },
    {
        path: '',
        redirectTo: 'main',
